...
class Square extends Shape {
    ...
    _loadGraphicsConfiguration() {
        let config = ShapeStyleConfig['square'];
                ...
                case 2:
                    ...
                    if (this._isPointCloseToLine(this._points[2], pPos, pNeg, this.clickTreshold)) {
                        ...
                        let vAB = pSub(B, A),
                            len = vLength(vAB),
                            v = pMul(1 / len, vAB), 
                            alpha = pointDistance(this._points[0], this._points[1]),
                            w = pMul(alpha, v),
                            P = pAdd(w, A);
    ...
    info() {
        ...
        parentInfo.area = { text: 'Arie pătrat', value: area};
        parentInfo.perimeter = { text: 'Perimetru pătrat', value: perimeter};
